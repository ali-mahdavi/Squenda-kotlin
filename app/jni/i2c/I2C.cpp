...
JNIEXPORT jint JNICALL Java_com_electropeyk_squenda_jni_I2C_init(JNIEnv *env, jobject obj,
                                                                 jstring file) {
...
JNIEXPORT jint JNICALL Java_com_electropeyk_squenda_jni_I2C_close(JNIEnv *env, jobject obj,
                                                                  jint fd) {
    if (close(fd) < 0)
        return errno;
    return 0;
...
JNIEXPORT jint JNICALL Java_com_electropeyk_squenda_jni_I2C_write(JNIEnv *env, jobject obj,
...
JNIEXPORT jint JNICALL Java_com_electropeyk_squenda_jni_I2C_read(JNIEnv *env, jobject obj,
                                                                 jint fd, jintArray buffer, jint len) {

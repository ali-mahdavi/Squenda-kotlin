...
Java_com_electropeyk_squenda_jni_UART_serialOpen(JNIEnv *env, jobject obj, jstring port, jint baud) {
...
JNIEXPORT jint JNICALL Java_com_electropeyk_squenda_jni_UART_serialClose(JNIEnv *env, jobject obj, jint fd) {
    if (close(fd) < 0) {
        //    LOGE("%d",errno);
        return -1;
    }
...
JNIEXPORT jint JNICALL
Java_com_electropeyk_squenda_jni_UART_serialWrite(JNIEnv *env, jobject obj, jint fd, jstring text) {
...
JNIEXPORT jint JNICALL
Java_com_electropeyk_squenda_jni_UART_serialRead(JNIEnv *env, jobject obj, jint fd, jcharArray buff) {

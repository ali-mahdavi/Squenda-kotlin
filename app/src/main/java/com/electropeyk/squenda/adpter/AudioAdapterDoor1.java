...
public class AudioAdapterDoor1 extends RecyclerView.Adapter<AudioAdapterDoor1.AudioAdapterViewHolder> {
    private static final String TAG = AudioAdapterDoor1.class.getSimpleName();
    ...
    public AudioAdapterDoor1(Context context, List<JcAudio> jcAudioList) {
        this.jcAudioList = jcAudioList;
        setHasStableIds(true);
        this.context = context;
        Paper.init(context);
        MetaAudio metaAudio = Paper.book(Common.DATABASE).read(Common.AUDIO_DOOR1);
        if (metaAudio != null)
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (checkedPosition != getAdapterPosition()) {
                        ...
                        Paper.book(Common.DATABASE).write(Common.AUDIO_DOOR1,

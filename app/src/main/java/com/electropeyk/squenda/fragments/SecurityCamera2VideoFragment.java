...
public class SecurityCamera2VideoFragment extends Fragment
    ...
    private AppCompatImageView btn_video, btn_gallary,
            btn_sound,
            btn_camera, img_back;
    private boolean soundVisibilityFlage;
    private AudioManager audioManager;

    private DiscreteSeekBar seek_volume;
    ...
    public static SecurityCamera2VideoFragment newInstance() {
        return new SecurityCamera2VideoFragment();
    }

...
public class MelodyDoor1Fragment extends Fragment implements View.OnClickListener {
    private JcPlayerView player;
    private RecyclerView recyclerView;
    private AudioAdapterDoor1 audioAdapter;
    ...
    private void adapterSetup() {
        audioAdapter = new AudioAdapterDoor1(getActivity(), player.getMyPlaylist());
        audioAdapter.setOnItemClickListener(new AudioAdapterDoor1.OnItemClickListener() {
            @Override

...
import com.electropeyk.squenda.adpter.AudioAdapterDoor1;
import com.electropeyk.squenda.adpter.AudioAdapterInterComm;
...
public class MelodyIntercomFragment extends Fragment implements View.OnClickListener {
    private JcPlayerView player;
    private RecyclerView recyclerView;
    private AudioAdapterInterComm audioAdapter;
    ...
    private void adapterSetup() {
        audioAdapter = new AudioAdapterInterComm(getActivity(),player.getMyPlaylist());
        audioAdapter.setOnItemClickListener(new AudioAdapterInterComm.OnItemClickListener() {
            @Override

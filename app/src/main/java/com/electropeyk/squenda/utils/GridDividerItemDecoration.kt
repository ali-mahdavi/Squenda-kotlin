 ...
 */
    (private val mHorizontalDivider: Drawable, private val mVerticalDivider: Drawable, private val mNumColumns: Int) :
    ...
    private fun drawHorizontalDividers(canvas: Canvas, parent: RecyclerView) {
        ...
        for (i in 1 until mNumColumns) {
            ...
            if (firstRowChild != null) {
                dividerTop = firstRowChild.top
                dividerRight = firstRowChild.left
            }


            val dividerLeft = dividerRight - mHorizontalDivider.intrinsicWidth
            var dividerBottom = 0
            if (lastRowChild != null)
                dividerBottom = lastRowChild.bottom
    ...
    private fun drawVerticalDividers(canvas: Canvas, parent: RecyclerView) {
        ...
        for (i in 1..rowCount) {
            ...
            if (leftmostChild != null)
                dividerLeft = leftmostChild.left
            if (leftmostChild != null)
                dividerBottom = leftmostChild.top
